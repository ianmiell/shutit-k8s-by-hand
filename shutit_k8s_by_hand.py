  ...
  config.vm.define "k8sbyhand3" do |k8sbyhand3|
    ...
    config.vm.provider :virtualbox do |vb|
      vb.name = "shutit_k8s_by_hand_3"
		...
		shutit_session_1.send('kubeadm init --apiserver-cert-extra-sans ' + machines['k8sbyhand1']['ip'] + ' --pod-network-cidr 10.244.0.0/16 --api-server-advertise-address ' + machines['k8sbyhand1']['ip'] + ' 2>&1 > /tmp/out')
